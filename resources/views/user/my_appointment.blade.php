  ...
  <table class="table">
    ...
    <tbody>
      <tr align="center">
        ...
        <td ><a href="{{url('cancel_appoint',$appoints->id)}}" onclick="return confirm('Are you sure you want to ancel your appointment')"><button class="btn btn-danger">cancle</button></a>
        </td>
      </tr>
      @endforeach
